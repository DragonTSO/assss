...
import com.example.asm_mob201.WebView1234.WebViewGiaoDuc;
...
public class RssTamSu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rss_tam_su);
        //
        ...
        String ad3 = "https://vnexpress.net/rss/tin-moi-nhat.rss";
        ...
        lstTieuDe.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(RssTamSu.this , WebViewGiaoDuc.class);
